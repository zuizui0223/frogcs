...
9. **Species activation geometry is repeatable:** early–late rho=.774 (P=.00044), WLS slope=.910, and 15/16 species retain the same spatial-edge versus local-deepening sign.
